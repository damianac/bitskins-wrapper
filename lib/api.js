...
class Bitskins {
  ...
  getAccountInventory(page = 1, app_id = 1) {
    return this.makeRequest('get_my_inventory', {page, app_id }, body => body.data);
  }
  ...
  buyItem(params) {
    ...
    return this.makeRequest('buy_item', params, body => body.data);
  }
  ...
  // Buy Orders
  getActiveBuyOrders(app_id = 730, page = 1) {
    return this.makeRequest('get_active_buy_orders', { app_id, page }, body => body.data);
  }
